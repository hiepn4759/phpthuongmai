			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-danhmuc')}}"><i class="icon-envelope"></i><span class="hidden-tablet">Tất cả danh mục sản phẩm</span></a></li>

						<li><a href="{{URL::to('/add-danhmuc')}}"><i class="icon-tasks"></i><span class="hidden-tablet">Thêm mới danh mục sản phẩm</span></a></li>
